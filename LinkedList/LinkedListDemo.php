...
<body>
    ...
    <h3>Створення списку на основі масиву <i><?php LinkedList::debug(arr);?></i></h3>
    <?php
        echo LinkedList::fromArray(arr)->toString(fn($el)=>$el->getValue() . ($el->hasNext() ? ' -> ' : '<br/>'));
    ?>
    <h3>Додавання елементів.</h3>
    <h4>Ланцюжок Перетворень: <i><?php LinkedList::debug(arr);?></i> ->append(1)->append(2)->append(3)->prepend(4)->append(3)->prepend(3).</h4>
    <?php
    ...
    <?php
        echo 'Довжина списку: ' . count($list) . '<br/>';
